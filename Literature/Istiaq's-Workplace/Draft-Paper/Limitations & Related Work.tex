...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item Limitation: No fairness or bias analysis
    \end{itemize}
    ...
    \begin{itemize}
        ...
        \item Limitation: Lack of interpretability
    \end{itemize}
\end{itemize}
\end{frame}
...
\begin{block}{Main Gap}
No existing work simultaneously optimizes:
\begin{itemize}
    \item Prediction accuracy
    \item Fairness across sensitive attributes
